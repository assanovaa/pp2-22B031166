...
blue_image = pygame.image.load('images/blue.png').convert_alpha()
red_image = pygame.image.load('images/red.png').convert_alpha()
green_image = pygame.image.load('images/green.png').convert_alpha()
pink_image = pygame.image.load('images/pink.png').convert_alpha()
eraser_image = pygame.image.load('images/eraser.png').convert_alpha()
